...
require (
	github.com/anatolykoptev/go-search v0.0.0
...
// Temporary: replace with local path until go_job grows its own engine.
// To decouple: copy needed packages from go-search into go_job/internal/engine/
// and remove this replace directive.
replace github.com/anatolykoptev/go-search => ../go-search
